...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference("Sensor.count") do
      post sensors_url, params: { sensor: { guid: @sensor.guid, name: @sensor.name, unitOfMeasure: @sensor.unitOfMeasure } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { guid: @sensor.guid, name: @sensor.name, unitOfMeasure: @sensor.unitOfMeasure } }
