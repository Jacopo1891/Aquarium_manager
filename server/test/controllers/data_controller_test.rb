...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { aquarium_id: @datum.aquarium_id, dataCapture: @datum.dataCapture, sensor_id: @datum.sensor_id, value: @datum.value } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { aquarium_id: @datum.aquarium_id, dataCapture: @datum.dataCapture, sensor_id: @datum.sensor_id, value: @datum.value } }
